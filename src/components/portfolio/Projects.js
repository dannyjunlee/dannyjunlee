    ...
    <div className='home'>
      <div className='container'>
        <div className='row align-items-center my-5'>
          ...
          <div className='col-lg-5'>
            <h1 className='font-weight-light'>
              <a href='https://github.com/dannyjunlee/restaurant-menu' rel='noreferrer' target='_blank'>Lucario's</a></h1>
            <p>
        ...
        <div className='row align-items-center my-5'>
          ...
          <div className='col-lg-5'>
            <h1 className='font-weight-light'>
              <a href='https://dannyjunlee.github.io/alpha-hub/' rel='noreferrer' target='_blank'>Alpha Hub</a></h1>
            <p>
        ...
        <div className='row align-items-center my-5'>
          ...
          <div className='col-lg-5'>
            <h1 className='font-weight-light'>
              <a href='https://dannyjunlee.github.io/weather-dashboard/' rel='noreferrer' target='_blank'>Weather Dashboard</a></h1>
            <p>
        ...
        <div className='row align-items-center my-5'>
          ...
          <div className='col-lg-5'>
            <h1 className='font-weight-light'>
              <a href='https://dannyjunlee.github.io/daily-planner/' rel='noreferrer' target='_blank'>Work Day Scheduler</a></h1>
            <p>
        ...
        <div className='row align-items-center my-5'>
          ...
          <div className='col-lg-5'>
            <h1 className='font-weight-light'>
              <a href='https://dannyjunlee.github.io/random-password-generator/' rel='noreferrer' target='_blank'>Random Password Generator</a></h1>
            <p>
